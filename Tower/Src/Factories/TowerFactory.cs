...
public static class TowerFactory
{
    ...
    private static ITower CreateFireTower(Vector2 position, Texture2D sprite) =>
        new FireTower(
            ...
            80m, // Здоровье (меньше, чем у каменной)
            30m, // Сила атаки (больше, чем у каменной)
    ...
    private static ITower CreateIceTower(Vector2 position, Texture2D sprite) =>
        new IceTower(
            ...
            90m, // Здоровье
            20m, // Сила атаки (меньше, но замедляет врагов)
    ...
    private static ITower CreateLightTower(Vector2 position, Texture2D sprite) =>
        new LightTower(
            ...
            120m, // Здоровье (больше, чем у других)
            35m, // Сила атаки (высокий урон)
            110, // Радиус атаки
    ...
    private static ITower CreatePoisonTower(Vector2 position, Texture2D sprite) =>
        new PoisonTower(
            ...
            85m, // Здоровье
            22m, // Сила атаки (средний урон, но яд наносит урон со временем)
